...
@section('content')
    ...
    <div class="col-lg-12 text-right">
        <a href="{{ route('certification.question.create') }}" class="btn btn-primary">
    ...
    <div class="col-lg-12">
        <div class="row">
            ...
            @else
                <div class="col-lg-12">
                    <div class="well well-sm text-center">Sem Questões.</div>
                </div>
            @endif
        </div>
    </div>
    ...
    <div class="col-lg-12">
        ...
        <div class="pull-right" style="padding:30px 0;">
            <p>
                Você está na página <strong>{{ $question->currentPage() }}</strong>
                 de <strong>{{ $question->lastPage() }}</strong>
                 exibindo <strong>{{ $question->count() }} Certificações</strong>
                 de <strong>{{ $question->total() }}</strong>.
            </p>
        </div>
    </div>
@endsection
